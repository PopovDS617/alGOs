...
func main() {
	...
	// queue.UseQueue()
	// stack.UseStack()
	// result := search.UseDFS("LastName", "Cooper", search.ExampleCompany)
	// fmt.Println("result is ", result)
	// result = search.UseBFS("LastName", "Cooper", search.ExampleCompany)
	// fmt.Println("result is ", result)
	...
	// data := []int{98, 1, 3, 5, 6, 2, 22, 400, 100}
	// res := sort.MergeSort(data)
